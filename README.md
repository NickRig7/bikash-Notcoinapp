...
1. **Clone the Repository**:
    ...
    ```bash
    git clone  https://github.com/NickRig7/bikash-Notcoinapp.git
    cd bikash-Notcoinapp
    ```
...
For any inquiries, please contact me in Telegram: [BIKASH DEKA](https://t.me/phexonick).
